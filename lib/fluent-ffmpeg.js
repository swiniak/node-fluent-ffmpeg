...
FfmpegCommand.ffprobe = function(file, options) {
  var instance = new FfmpegCommand(file, options);
  instance.ffprobe.apply(instance, Array.prototype.slice.call(arguments, 2));
};
